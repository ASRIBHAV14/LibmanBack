...
public class UsersCon {
	...
	public ResponseEntity<Users> registerUserDetails(@RequestBody UserDto user) throws Throwable 
	{
   ...
   public ResponseEntity<Users> updateUserDetails(@RequestBody UserDto user)throws Throwable
   {
